                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input name ="user_name" type="text" class="form-control" id="name" placeholder="User Name *" required>
                                            <label for="name">User Name *</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input name ="user_phone" type="text" class="form-control" id="phone" placeholder="User phone *" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input name ="user_email" type="email" class="form-control" id="email" placeholder="User Email *" required>
